...
export default function AdminDashboardContent({
  ...
  const radarData =
    radarTrack === "Functional"
      ? functionalRadarData
      : radarTrack === "Managerial"
        ? managerialRadarData
        : coreRadarData;
  ...
  return (
    ...
    >
            ...
            >
              <div className="space-y-1">
                <div className="flex justify-between items-start w-full">
                  ...
                  <item.icon
                    className={`w-4 h-4 ${item.textColor} shrink-0 ml-2`}
                  />
                </div>
                <h3 className="text-[24px] font-bold text-gray-700 dark:text-white leading-none">
                  {item.isScore ? (
                    ...
                    <AnimatedNumber
                      ...
                      decimals={item.isFloat ? 1 : 0}
                    />
                  )}
                </h3>
              </div>
              <p className={`text-[11px] font-normal ${item.textColor}`}>
                {item.trend}
              </p>
            </Card>
          ))}
      ...
      <div className="grid grid-cols-12 gap-4 items-stretch">
        ...
        <Card
          className="col-span-12 xl:col-span-5 p-4 rounded-lg bg-white dark:bg-gray-800 border-none shadow-none relative"
          style={{
            opacity: isMounted ? 1 : 0,
        ...
        >
          ...
          <div className="flex items-baseline justify-between mb-2 relative z-20">
            ...
            <div className="relative" ref={trackRef}>
              ...
              >
                {radarTrack}
                <ChevronDown
                  className={`w-3.5 h-3.5 transition-transform duration-300 ${trackOpen ? "rotate-180 text-[#FC4C02]" : "text-gray-500"}`}
                />
              </button>
              <div
                className={`absolute top-full right-0 mt-2 w-38 bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-xl p-1 z-50 shadow-xl transition-all duration-300 origin-top-right ${trackOpen ? "opacity-100 scale-100" : "opacity-0 scale-95 pointer-events-none"}`}
              >
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-start relative z-10 -mt-4">
            <div className="w-full lg:w-1/2 aspect-square flex items-center justify-start -mt-10">
              <ChartContainer
                ...
                className="w-full h-full max-h-65 outline-none focus:outline-none **:outline-none"
              >
                <RadarChart
                  data={radarData}
          ...
          <div className="-mt-10 relative z-10 text-left w-full">
            <h3 className="text-[18px] font-medium text-[#08060d] dark:text-white mb-2 leading-tight">
              Platform Activity
            </h3>
        ...
        <Card
          className="col-span-12 md:col-span-6 xl:col-span-3 p-4 rounded-lg bg-white dark:bg-gray-800 border-none shadow-none h-full text-left"
          style={{
            opacity: isMounted ? 1 : 0,
          ...
          <div className="flex flex-col gap-4">
            ...
            <section className="w-full">
              <div className="flex items-center justify-between mb-2.5">
                <h3 className="text-[18px] font-medium text-[#08060d] dark:text-white leading-tight">
                  Needs Attention
                </h3>
                <button
            ...
            {/* Top org-wide gaps */}
            <section className="w-full">
              <h3 className="text-[18px] font-medium text-[#08060d] dark:text-white mb-2.5 leading-tight">
                Top Org Gaps
              </h3>
              <div className="space-y-2.5">
                {ORG_GAPS.map((g, i) => (
                  <div
                    ...
                    style={{
                      opacity: isMounted ? 1 : 0,
                      transition: `opacity .4s ease ${0.5 + i * 0.08}s`,
                    }}
                  >
                    <div className="flex items-center justify-between mb-1">
                      <div className="flex items-center gap-1.5">
                        <span
                          className={`text-[10px] font-bold ${TRACK_COLOR[g.track]}`}
                        >
                          {g.track[0]}
                        </span>
        ...
        <Card
          className="col-span-12 md:col-span-6 xl:col-span-4 p-4 rounded-lg bg-white dark:bg-gray-800 border-none shadow-none h-full"
          style={{
            opacity: isMounted ? 1 : 0,
        ...
        >
          <div className="flex flex-col gap-3.5 h-full">
              ...
              {[
                ...
                >
                  ...
                  <div className="flex-1 text-left">
                    <p className="text-[12px] text-gray-500 dark:text-gray-400 font-normal">
                      {s.label}
                    </p>
                    <p className="text-[18px] font-bold text-gray-800 dark:text-white leading-tight">
                      {s.value}
                    </p>
                  </div>
            ...
            <div className="mt-auto pt-2 flex flex-col gap-2">
              ...
              >
                <span className="flex items-center gap-2">
                  <CheckCircle2 className="w-3.5 h-3.5" /> Manage Competencies
                </span>
                <ArrowRight className="w-3.5 h-3.5" />
              </button>
            </div>
      ...
      <div className="grid grid-cols-12 gap-4 items-stretch">
        {/* IDP Progress */}
        <Card
          className="col-span-12 xl:col-span-5 pt-4 pb-0 px-0 rounded-lg bg-white dark:bg-gray-800 border-none shadow-none relative overflow-hidden"
          style={{
            opacity: isMounted ? 1 : 0,
            transition: "opacity .6s ease 400ms",
          }}
        >
          <div className="flex items-center justify-between px-4 mb-0">
            <h2 className="text-[18px] font-medium text-[#08060d] dark:text-white leading-none">
              IDP Progress
            </h2>
            <button
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-gray-400">
                          {u.role} · {u.courses} courses
                        </p>
                      </div>
                    </div>
                    <span
                      className={`text-[10px] font-semibold rounded-full px-2.5 py-0.5 shrink-0 ${
                        u.status === "On Track"
        ...
        <Card
          className="col-span-12 md:col-span-6 xl:col-span-4 pt-4 pb-0 px-0 rounded-lg bg-white dark:bg-gray-800 border-none shadow-none relative overflow-hidden"
          style={{
            opacity: isMounted ? 1 : 0,
                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between gap-3 mb-3">
                      <div>
                        <span
                          className={`inline-block text-[10px] font-semibold px-2 py-0.5 rounded-full mb-1 ${TRACK_BG[c.track]}`}
                        >
                          {c.track}
                        </span>
                        <p className="text-[13px] font-semibold text-gray-800 dark:text-white leading-tight">
                      ...
                      <div className="text-right shrink-0">
                        <p className="text-[12px] font-bold text-gray-700 dark:text-white">
        ...
        {/* Leaderboard */}
        <Card
          className="col-span-12 md:col-span-6 xl:col-span-3 p-4 rounded-lg bg-white dark:bg-gray-800 border-none shadow-none h-full"
          style={{
            opacity: isMounted ? 1 : 0,
            transition: "opacity .6s ease 600ms",
          }}
        >
          <div className="flex flex-col gap-3.5">
            ...
            <div className="space-y-2">
              {[
                ...
                >
                  <span
                    className={`text-[11px] font-bold w-5 text-center shrink-0 ${u.rank <= 3 ? "text-amber-500" : "text-gray-400"}`}
                  >
                    {u.rank <= 3
                      ? ["🥇", "🥈", "🥉"][u.rank - 1]
                      : `#${u.rank}`}
                  ...
                  <span className="text-[12px] font-bold text-[#fc4c02] shrink-0">
                    {u.score.toFixed(1)}
                  </span>
                </div>
              ))}
