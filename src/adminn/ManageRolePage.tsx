...
function ManageRolePage() {
  ...
  const getRoleBadgeColor = (role: string) => {
    if (role === "Team Lead") return "bg-orange-100 text-orange-600 dark:bg-orange-900/30 dark:text-orange-400";
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-start justify-between gap-6">
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1" style={{ fontFamily: 'Geometrica, sans-serif' }}>
              Manage All User
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm flex-1">
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-1" style={{ fontFamily: 'Geometrica, sans-serif' }}>
              Total Users
            </p>
            <p className="text-3xl font-bold text-gray-900 dark:text-white" style={{ fontFamily: 'Geometrica, sans-serif' }}>
              {totalUsers}
            </p>
          </div>
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm flex-1">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200 dark:border-gray-700">
                  <th className="px-6 py-4 text-left text-sm font-semibold text-gray-900 dark:text-white" style={{ fontFamily: 'Geometrica, sans-serif' }}>
                    Name
                  </th>
                  <th className="px-6 py-4 text-left text-sm font-semibold text-gray-900 dark:text-white" style={{ fontFamily: 'Geometrica, sans-serif' }}>
                    ROLE
                  ...
                  >
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        />
                        <div>
                          <p className="font-semibold text-gray-900 dark:text-white" style={{ fontFamily: 'Geometrica, sans-serif' }}>
                            {user.name}
                          </p>
                          ...
                          {user.competencyScore && (
                            <p className="text-xs text-gray-500 dark:text-gray-500 mt-1" style={{ fontFamily: 'Geometrica, sans-serif' }}>
                              {user.competencyScore}
                            </p>
                          )}
                        </div>
