...
const COMPETENCIES: Competency[] = [
  {
    ...
    name: "Create Impact",
    description:
      "Drives meaningful work with clear ownership of role and organizational value.",
  },
  {
    code: "CC02",
    track: "Core",
    name: "Take Ownership",
    description:
      "Owns work end-to-end; solves problems without escalating prematurely.",
  },
  {
    code: "CC03",
    track: "Core",
    name: "Adaptive",
    description: "Strong problem solver; continuous learner; embraces change.",
  },
  {
    code: "CC04",
    track: "Core",
    name: "Collaboration",
    description:
      "Works effectively in teams; understands own role and responsibilities.",
  },
  {
    code: "FC01",
    track: "Functional",
    name: "Data Analysis",
    description: "Extracts insights from data to support business decisions.",
  },
  {
    code: "FC02",
    track: "Functional",
    ...
    description:
      "Communicates clearly and effectively with all stakeholder levels.",
  },
  {
    code: "FC03",
    track: "Functional",
  ...
  },
  {
    ...
    description:
      "Delivers projects on time, on scope, and to quality standards.",
  },
  {
    code: "FC05",
    track: "Functional",
  ...
  },
  {
    ...
    name: "Process",
    description:
      "Plans, organizes, delegates, and keeps work running smoothly.",
  },
  {
    code: "MC02",
    track: "Managerial",
    name: "Purpose",
    description: "Sets vision, thinks strategically, and manages risk.",
  },
  {
    code: "MC03",
    track: "Managerial",
    name: "People",
    description: "Develops talent, coaches, and builds high-performing teams.",
  },
  {
    code: "MC04",
    track: "Managerial",
    name: "Result",
    description: "Drives outcomes, raises efficiency, and holds standards.",
  },
];
...
const USERS: UserProfile[] = [
  {
    ...
    level: "L3",
    scores: [
      { code: "CC01", actual: 2, expected: 3 },
      { code: "CC02", actual: 2, expected: 3 },
      { code: "CC03", actual: 3, expected: 3 },
      { code: "CC04", actual: 3, expected: 4 },
      { code: "FC01", actual: 2, expected: 3 },
      { code: "FC02", actual: 3, expected: 3 },
      { code: "FC03", actual: 2, expected: 3 },
      { code: "FC04", actual: 3, expected: 3 },
      { code: "FC05", actual: 2, expected: 3 },
      { code: "MC01", actual: 2, expected: 3 },
      { code: "MC02", actual: 3, expected: 3 },
      { code: "MC03", actual: 2, expected: 3 },
  ...
  },
  {
    ...
    scores: [
      { code: "CC01", actual: 2, expected: 3 },
      { code: "CC02", actual: 3, expected: 3 },
      { code: "CC03", actual: 2, expected: 3 },
      { code: "CC04", actual: 4, expected: 4 },
      { code: "FC01", actual: 4, expected: 4 },
      { code: "FC02", actual: 2, expected: 3 },
      { code: "FC03", actual: 3, expected: 4 },
      { code: "FC04", actual: 2, expected: 3 },
      { code: "FC05", actual: 3, expected: 3 },
      { code: "MC01", actual: 3, expected: 3 },
      { code: "MC02", actual: 2, expected: 3 },
      { code: "MC03", actual: 3, expected: 4 },
  ...
  },
  {
    ...
    level: "L3",
    scores: [
      { code: "CC01", actual: 3, expected: 4 },
      { code: "CC02", actual: 4, expected: 4 },
      { code: "CC03", actual: 3, expected: 3 },
      { code: "CC04", actual: 4, expected: 4 },
      { code: "FC01", actual: 3, expected: 3 },
      { code: "FC02", actual: 4, expected: 4 },
      { code: "FC03", actual: 3, expected: 4 },
      { code: "FC04", actual: 3, expected: 3 },
      { code: "FC05", actual: 2, expected: 3 },
      { code: "MC01", actual: 4, expected: 4 },
      { code: "MC02", actual: 3, expected: 4 },
      { code: "MC03", actual: 4, expected: 4 },
  ...
  },
  {
    ...
    level: "L3",
    scores: [
      { code: "CC01", actual: 3, expected: 3 },
      { code: "CC02", actual: 3, expected: 3 },
      { code: "CC03", actual: 2, expected: 3 },
      { code: "CC04", actual: 4, expected: 4 },
      { code: "FC01", actual: 2, expected: 3 },
      { code: "FC02", actual: 4, expected: 4 },
      { code: "FC03", actual: 3, expected: 3 },
      { code: "FC04", actual: 3, expected: 3 },
      { code: "FC05", actual: 2, expected: 3 },
      { code: "MC01", actual: 3, expected: 3 },
      { code: "MC02", actual: 3, expected: 3 },
  ...
  },
  {
    ...
    level: "L5",
    scores: [
      { code: "CC01", actual: 4, expected: 4 },
      { code: "CC02", actual: 4, expected: 4 },
      { code: "CC03", actual: 4, expected: 4 },
      { code: "CC04", actual: 4, expected: 4 },
      { code: "FC01", actual: 4, expected: 4 },
      { code: "FC02", actual: 3, expected: 4 },
      { code: "FC03", actual: 4, expected: 4 },
      { code: "FC04", actual: 4, expected: 4 },
      { code: "FC05", actual: 4, expected: 4 },
      { code: "MC01", actual: 4, expected: 4 },
      { code: "MC02", actual: 3, expected: 4 },
      { code: "MC03", actual: 3, expected: 4 },
  ...
  },
  {
    ...
    scores: [
      ...
      { code: "CC02", actual: 2, expected: 3 },
      { code: "CC03", actual: 3, expected: 3 },
      { code: "CC04", actual: 3, expected: 3 },
      { code: "FC01", actual: 2, expected: 3 },
      { code: "FC02", actual: 3, expected: 3 },
      { code: "FC03", actual: 2, expected: 3 },
      { code: "FC04", actual: 2, expected: 3 },
      { code: "FC05", actual: 2, expected: 3 },
      { code: "MC01", actual: 1, expected: 2 },
      { code: "MC02", actual: 1, expected: 2 },
      { code: "MC03", actual: 1, expected: 2 },
...
export default function AdminCompetencyProfilePage() {
  ...
  // org-wide gaps
  const orgTotalGaps = USERS.reduce(
    (acc, u) =>
      acc +
  ...
  const orgAvgActual =
    USERS.reduce(
      (acc, u) =>
        acc +
        COMPETENCIES.reduce((a, c) => a + getScore(c.code, u.id).actual, 0),
      0,
    ) /
  ...
  const avgExpected =
    scores.reduce((s, x) => s + x.expected, 0) / scores.length;
  ...
  const metricCards: {
    ...
    {
      label: "Expected Not Set",
      value: notSavedCount,
      icon: <ClipboardList className="w-4 h-4 text-purple-500" />,
      trend: notSavedCount === 0 ? "All configured!" : "Users pending",
      trendColor:
        notSavedCount === 0
          ? "text-emerald-500"
    ...
    {
      label: "Expected Configured",
      value: savedCount,
      icon: <Sparkles className="w-4 h-4 text-emerald-500" />,
      trend: `of ${USERS.length} members`,
      ...
      <div className="flex gap-4 items-start">
        ...
        >
          ...
          <div className="px-4 pt-4 pb-3 border-b border-gray-100 dark:border-gray-700">
            <p className="text-[13px] font-bold text-gray-800 dark:text-white mb-3">
              All Members
            </p>
            ...
            <div ref={teamRef} className="relative">
              ...
              >
                ...
                <ChevronDown
                  size={12}
                  className={`transition-transform ${teamOpen ? "rotate-180 text-[#fc4c02]" : ""}`}
                />
              </button>
              {teamOpen && (
            ...
            {filtered.map((u, i) => {
              ...
              return (
                <button
                  ...
                  style={{
                    opacity: isMounted ? 1 : 0,
                    transition: `opacity .4s ease ${0.3 + i * 0.06}s`,
                  }}
                >
                  <div
                    className="w-8 h-8 rounded-full flex items-center justify-center text-white text-[11px] font-bold shrink-0"
                    style={{
                      background: isActive ? "#fc4c02" : USER_COLORS[u.id],
                    }}
                  >
                    {u.initials}
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-1">
                      <p
                        className={`text-[12px] font-semibold truncate ${isActive ? "text-orange-700 dark:text-orange-400" : "text-gray-800 dark:text-white"}`}
                      >
                        {u.name}
                      </p>
                      {uGaps > 0 && (
                        <span className="text-[10px] font-bold bg-red-50 text-red-500 rounded-full px-1.5 py-0.5 shrink-0">
                          {uGaps} gap{uGaps !== 1 ? "s" : ""}
                        </span>
                      )}
                    </div>
        ...
        <div className="flex-1 min-w-0 space-y-3">
          {/* Profile header */}
          <Card
            className="bg-white dark:bg-gray-800 border-none shadow-none px-5 py-4 rounded-2xl"
            style={{
              opacity: isMounted ? 1 : 0,
              transition: "opacity .5s ease 350ms",
            }}
          >
            <div className="flex items-center gap-4">
              <div
                ...
                style={{
                  background: `linear-gradient(135deg, ${USER_COLORS[user.id]}, ${USER_COLORS[user.id]}bb)`,
                }}
              >
                {user.initials}
              </div>
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span
                    className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${LEVEL_BG[parseInt(user.level.replace("L", ""))]}`}
                  >
                    {user.level}
                  </span>
                  {isSaved && (
                ...
                <p className="text-[13px] text-gray-500 dark:text-gray-400">
                  {user.role} · {user.team} · {user.tenure}
                </p>
              </div>
          ...
          <div className="flex gap-2">
            {(["Core", "Functional", "Managerial"] as Track[]).map((t) => {
              const tGaps = COMPETENCIES.filter((c) => c.track === t).filter(
                (c) => {
                  const s = getScore(c.code);
                  return s.expected > s.actual;
                },
              ...
              return (
                ...
                >
                  ...
                  {tGaps > 0 && (
                    <span
                      className={`text-[10px] font-bold rounded-full px-1.5 py-0.5 ${active ? "bg-white/20 text-white dark:bg-black/20 dark:text-white" : "bg-red-50 text-red-500"}`}
                    >
                      {tGaps}
                    </span>
                  )}
          ...
          <div className="grid grid-cols-5 gap-4 items-start">
            {/* Radar */}
            <Card
              className="col-span-2 bg-white dark:bg-gray-800 border-none shadow-none p-4 rounded-2xl"
              style={{
                opacity: isMounted ? 1 : 0,
              ...
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex items-center gap-3 text-[10px] text-gray-400">
                  <span className="flex items-center gap-1">
                    <span className="w-2 h-2 rounded-full bg-[#FC4C02] inline-block" />
                    Actual
                  </span>
                  <span className="flex items-center gap-1">
              ...
              <ResponsiveContainer width="100%" height={200}>
                ...
                >
                  ...
                  <Tooltip
                    ...
                    formatter={(v) => [
                      String(Math.round(Number(v) / 25)) + " / 4",
                    ]}
                  />
                  <Radar
                    dataKey="expected"
              ...
              <div className="mt-2 grid grid-cols-2 gap-2">
                {[
                  ...
                  <div key={i} className={`${s.bg} rounded-xl px-3 py-2`}>
                    ...
                    <p
                      className={`text-[18px] font-bold ${s.textColor} leading-none`}
                    >
                      {s.value}
            ...
            <div className="col-span-3 space-y-2.5">
              <div className="grid grid-cols-[1fr_auto_auto_auto] gap-x-4 px-4 py-1">
                ...
                <p className="text-[10px] uppercase tracking-widest text-gray-400 font-semibold w-20 text-center">
                  Actual
                </p>
                <p className="text-[10px] uppercase tracking-widest text-gray-400 font-semibold w-28 text-center">
                  Expected (set)
                </p>
                <p className="text-[10px] uppercase tracking-widest text-gray-400 font-semibold w-12 text-center">
                  Gap
                </p>
              </div>
              ...
              {trackComps.map((comp, ci) => {
                ...
                return (
                  <div
                    ...
                    style={{
                      opacity: isMounted ? 1 : 0,
                      transition: `opacity .4s ease ${0.4 + ci * 0.06}s`,
                    }}
                  >
                    <div className="grid grid-cols-[1fr_auto_auto_auto] gap-x-4 items-center">
                      <div className="min-w-0">
                        <div className="flex items-center gap-2 mb-0.5">
                          <span
                            className={`text-[10px] font-bold ${TRACK_COLOR[comp.track]}`}
                          >
                            {comp.code}
                          </span>
                          ...
                          {isEdited && (
                            <span className="text-[9px] font-semibold text-orange-500 bg-orange-50 rounded-full px-1.5 py-0.5">
                              edited
                            </span>
                          )}
                        </div>
                      ...
                      <div className="w-28 flex flex-col items-center gap-1">
                        ...
                        <Stepper
                          value={s.expected}
                          onChange={(v) => setExpected(comp.code, v)}
                        />
                      </div>
                ...
                <div className="flex items-center justify-between bg-orange-50 dark:bg-orange-900/20 border border-orange-100 dark:border-orange-800 rounded-2xl px-4 py-3">
                  <p className="text-[12px] text-orange-700 dark:text-orange-300">
                    <span className="font-semibold">
                      {Object.keys(edits[user.id] ?? {}).length}
                    </span>{" "}
                    expected score
                    {Object.keys(edits[user.id] ?? {}).length !== 1
                      ? "s"
                      : ""}{" "}
                    changed for{" "}
                  ...
                  <div className="flex gap-2">
                    <button
                      onClick={resetUser}
                      className="text-[12px] text-orange-600 hover:text-orange-800 border border-orange-200 rounded-xl px-3 py-1.5 transition-colors"
                    >
                      Reset
                    </button>
                    <button
                      onClick={saveUser}
                      className="text-[12px] font-semibold bg-gray-900 text-white rounded-xl px-4 py-1.5 hover:bg-gray-700 transition-colors flex items-center gap-1.5"
                    >
