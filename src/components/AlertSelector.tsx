...
const INITIAL_NOTIFS: Notif[] = [
  {
    ...
    message:
      "Product Manager in the Product team has 7 competencies below expected. IDP review recommended.",
    time: "5 min ago",
    read: false,
    initials: "JP",
    color: "#f97316",
  },
  {
    ...
    message:
      "Finance Lead has 6 competencies below expected including Stakeholder Communication and Project Execution.",
    time: "12 min ago",
    read: false,
    initials: "LV",
    color: "#8b5cf6",
  },
  {
    ...
    message:
      "Senior Analyst has the worst gap score of −2 on Stakeholder Communication. Courses have been suggested.",
    time: "30 min ago",
    read: false,
    initials: "TC",
    color: "#ec4899",
  },
  {
    ...
    message:
      '"Q2 Learning Goals" announcement has been published to all employees.',
    time: "1h ago",
    read: false,
    initials: "AD",
    color: "#006BFF",
  },
  {
    ...
    message:
      "Engineering Manager achieved 8 strengths this cycle. Recognised as a top performer.",
    time: "2h ago",
    read: true,
    initials: "SF",
    color: "#10b981",
  },
  {
    ...
    message:
      "Chris Dana and Pat Linh do not have a role assigned. Please update in Manage Role.",
    time: "3h ago",
    read: true,
    initials: "MR",
    color: "#6366f1",
  },
  {
    ...
    message:
      "Senior Designer achieved 6 strengths with a positive +0.6 trend this cycle.",
    time: "5h ago",
    read: true,
    initials: "AN",
    color: "#3b82f6",
    ...
    <div className="relative">
      ...
      >
        <div className={`relative ${isHovered ? "animate-alert-ring" : ""}`}>
          <Bell className="w-5 h-5 transition-colors duration-300 group-hover:text-[#ffa400]" />
          {unreadCount > 0 && (
        ...
        >
          ...
          <div className="flex items-center gap-1 px-5 pt-3 pb-1">
            ...
            >
              ...
              {unreadCount > 0 && (
                <span
                  className={`text-[10px] rounded-full px-1.5 py-0.5 ${tab === "unread" ? "bg-white/20 dark:bg-gray-900/20" : "bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300"}`}
                >
                  {unreadCount}
                </span>
              )}
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-1.5 mb-0.5 flex-wrap">
                    <span
                      className={`inline-flex items-center gap-1 text-[10px] font-semibold px-1.5 py-0.5 rounded ${LEVEL_BADGE[n.level]}`}
                    >
                      {LEVEL_ICON[n.level]}
                      {n.level}
                    </span>
