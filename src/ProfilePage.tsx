      ...
      <div className="px-8 -mt-10 relative z-10">
        ...
        <div className="flex items-start justify-between mb-8">
          ...
          <div className="flex items-start gap-6">
            ...
            >
              {!avatarImage && <span className="text-4xl font-bold text-gray-900 group-hover:opacity-50 transition-opacity">TC</span>}
            ...
            <div className="mt-6">
              <div className="flex items-center gap-3 mb-0">
                <h1 className="text-m font-bold text-gray-900 text-left">Tarin Chongprajert</h1>
              ...
              <p className="text-m text-left text-gray-600">Fullstack Developer</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {/* Skills & Competencies */}
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-4 text-left">Skills & Competencies</h2>
            ...
            {/* Recent Projects */}
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-4 text-left">Recent Projects</h2>
              <div className="space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    description: 'Developed interactive data visualization dashboard for business metrics',
                    tech: ['TypeScript', 'D3.js', 'PostgreSQL'],
                    status: 'In Progress'
                  },
                  {
                    title: 'Mobile API Gateway',
                    description: 'Designed and implemented RESTful API gateway for mobile applications',
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-4 text-left">Certifications & Badges</h2>
