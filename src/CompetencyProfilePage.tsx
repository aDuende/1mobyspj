...
export default function CompetencyProfilePage({
  ...
  const coreDefinitions = [
    ...
    {
      title: "Adaptive",
      description: "สามารถแก้ไขปัญหาได้ดี รักการเรียนรู้ เปิดรับการเปลี่ยนแปลง",
    },
    {
      title: "Collaboration",
      description:
  ...
  const managerialDefinitions = [
    {
      title: "Process",
      description:
        "ความสามารถในการวางแผน จัดระเบียบงาน ติดตามความคืบหน้า มอบหมายและให้อำนาจตัดสินใจ รวมถึงการแก้ไขปัญหาและวิเคราะห์อย่างเป็นระบบ เพื่อให้งานดำเนินไปได้อย่างราบรื่นและบรรลุเป้าหมาย",
    },
    {
      title: "Purpose",
      description:
        "ความสามารถในการกำหนดวิสัยทัศน์ที่ชัดเจน คิดเชิงกลยุทธ์ บริหารความเสี่ยง และกำหนดเป้าหมายที่สอดคล้องกับทิศทางองค์กร",
    },
    {
      title: "People",
      description:
        "ความสามารถในการสร้างความไว้วางใจ แรงบันดาลใจ การโค้ชและพัฒนาทักษะของทีม สนับสนุนการทำงานร่วมกัน จัดการทรัพยากรอย่างเหมาะสม",
    },
    {
      title: "Result",
      description:
        "ความสามารถในการขับเคลื่อนผลงานโดยมุ่งเน้นผลลัพธ์ เพิ่มประสิทธิภาพ รวมถึงการรักษามาตรฐาน",
    },
  ];
  ...
  const fadeUp = (ms: number) => ({
    ...
    transition: `opacity .6s ease-out ${ms}ms, transform .6s ease-out ${ms}ms`,
  });
  const fadeRight = (ms: number) => ({
    opacity: isMounted ? 1 : 0,
    transform: isMounted ? "translateX(0)" : "translateX(20px)",
    transition: `opacity .6s ease-out ${ms}ms, transform .6s ease-out ${ms}ms`,
  });
  const fadeLeft = (ms: number) => ({
    opacity: isMounted ? 1 : 0,
    transform: isMounted ? "translateX(0)" : "translateX(-20px)",
    transition: `opacity .6s ease-out ${ms}ms, transform .6s ease-out ${ms}ms`,
  });
      ...
      <main className="flex flex-1 flex-col gap-6 p-4 md:gap-8 md:p-8">
          ...
          {[
            {
              ...
              sub: (
                <>
                  <Sparkles className="h-3 w-3 animate-pulse" /> Excellent
                  Progress
                </>
              ),
              delay: 0,
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-7">
          ...
          <div className="lg:col-span-4 space-y-6">
            {/* Profile */}
            <Card
              className="border-none shadow-lg bg-gradient-to-br from-white to-blue-50/50 dark:from-gray-800 dark:to-gray-900 overflow-hidden relative hover:shadow-2xl transition-all duration-500 hover:-translate-y-1"
              style={fadeUp(400)}
            >
                ...
                <div className="flex items-center gap-3">
                  <div className="relative group shrink-0">
                    ...
                    <Avatar className="h-14 w-14 rounded-lg relative ring-2 ring-white dark:ring-gray-800 group-hover:scale-105 transition-transform duration-500">
                      ...
                      />
                      <AvatarFallback className="text-lg bg-gradient-to-br from-pink-500 to-rose-500 text-white font-bold rounded-lg">
                        TC
                      </AvatarFallback>
                    </Avatar>
                  </div>
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      <span className="px-2.5 py-0.5 bg-gradient-to-r from-amber-400 to-orange-400 text-white rounded-full text-xs font-semibold shadow-md">
                        Level 2
                      </span>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {/* Top Strengths */}
              <Card
                className="p-4 rounded-2xl bg-white dark:bg-gray-800 border-none shadow-sm h-full text-left"
                style={fadeLeft(500)}
              >
                <div className="flex flex-col gap-4 items-start">
                  <section className="w-full text-left">
                    <h3
                      className="!text-[18px] font-medium !text-[#08060d] dark:!text-white mb-2.5 text-left leading-tight flex items-center gap-2"
                    ...
                    <div className="w-full rounded-2xl bg-white dark:bg-gray-800 border border-gray-200/60 dark:border-white/5 shadow-[inset_0_1px_4px_rgba(0,0,0,0.06)] hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 cursor-pointer p-3 space-y-2.5">
                      {topStrengths.map((item, i) => (
                        <div
                          ...
                          style={{
                            opacity: isMounted ? 1 : 0,
                            transition: `opacity .4s ease-out ${0.6 + i * 0.1}s`,
                          }}
                        >
              ...
              <CardContent className="space-y-4">
                {activeDefinitions.map((def, i) => (
                  <div
                    ...
                    style={{
                      opacity: 1,
                      animation: `fadeSlideIn .35s ease-out ${i * 0.07}s both`,
                    }}
                  >
