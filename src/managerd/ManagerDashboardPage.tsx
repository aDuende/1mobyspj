...
const heatColumns: {
  key: keyof (typeof teamMembers)[0]["scores"];
  label: string;
}[] = [
...
const generateMockContributions = (): ContributionData[] => {
  ...
  while (current <= endDate) {
    const diffDays = Math.floor(
      (current.getTime() - firstSunday.getTime()) / (1000 * 60 * 60 * 24),
    );
    ...
    <div className="p-6 space-y-4 bg-[#f8fafc] dark:bg-transparent min-h-screen">
      ...
      <div className="flex flex-col xl:flex-row gap-3 items-stretch">
        ...
        <div className="relative overflow-hidden w-full xl:w-[400px] h-[140px] shrink-0 group rounded-lg p-0">
          ...
          <div className="relative p-6 h-full flex flex-col justify-start pt-6 text-left">
            <p
              className="text-[11px] font-normal mb-1"
              style={{ ...GEO, color: "#723434" }}
            >
              Welcome back
            </p>
            <p
              className="!text-[18px] font-normal text-gray-900 dark:text-white leading-tight whitespace-nowrap"
              style={GEO}
            >
            ...
            >
              <div className="space-y-1">
                <div className="flex justify-between items-start w-full">
                  <p
                    className="text-[11px] text-gray-600 dark:text-gray-400 font-normal leading-tight"
                    style={GEO}
                  >
                    {item.label}
                  </p>
                ...
                <h3
                  className="text-[24px] font-bold text-gray-700 dark:text-white leading-none"
                  style={GEO}
                >
              ...
              <p
                className={`text-[11px] font-normal ${item.textColor}`}
                style={GEO}
              >
                {item.trend}
              </p>
      ...
      <div className="grid grid-cols-12 gap-4 items-stretch">
        ...
        <Card className="col-span-12 xl:col-span-5 p-4 rounded-lg bg-white dark:bg-gray-800 border-none shadow-none relative">
          ...
          <div className="flex items-baseline justify-between mb-2 relative z-20">
            ...
            <div className="relative" ref={categoryRef}>
              ...
              >
                {selectedCategory}
                <ChevronDown
                  className={`w-3.5 h-3.5 transition-transform duration-300 ${isCategoryOpen ? "rotate-180 text-[#FC4C02]" : "rotate-0 text-gray-500 group-hover:text-gray-900 dark:group-hover:text-white"}`}
                />
              </button>
              <div
                className={`absolute top-full right-0 mt-2 w-38 bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-xl border border-gray-200/50 dark:border-transparent p-1 z-50 transition-all duration-300 origin-top-right shadow-xl ${isCategoryOpen ? "opacity-100 scale-100 translate-y-0" : "opacity-0 scale-95 -translate-y-2 pointer-events-none"}`}
              >
          ...
          <div className="-mt-10 relative z-10 text-left w-full">
            <h3
              className="!text-[18px] font-medium !text-[#08060d] dark:!text-white mb-2 leading-tight"
              style={GEO}
            >
              Activity
            </h3>
        ...
        <Card className="col-span-12 md:col-span-6 xl:col-span-3 p-4 rounded-lg bg-white dark:bg-gray-800 border-none shadow-none h-full text-left">
          <div className="flex flex-col gap-4 items-start">
            <section className="w-full">
              <h3
                className="!text-[18px] font-medium !text-[#08060d] dark:!text-white mb-2.5 leading-tight"
                style={GEO}
              >
                Team Strengths
              </h3>
      ...
      <div className="grid grid-cols-12 gap-4 items-stretch">
        ...
        <Card className="col-span-12 xl:col-span-8 p-4 rounded-lg bg-white dark:bg-gray-800 border-none shadow-none">
          <h2
            className="!text-[18px] font-medium !text-[#08060d] dark:!text-white mb-4 leading-tight text-left w-full"
            style={GEO}
          >
            Team Competency HeatMap
          </h2>
                  ...
                  >
                    ...
                    <div className="w-[180px] shrink-0 flex items-center gap-2.5">
                      ...
                      <div className="flex items-center gap-1 min-w-0">
                        <span
                          className="text-[13px] font-medium text-gray-800 dark:text-gray-200 truncate"
                          style={GEO}
                        >
                          {member.name}
                        </span>
                    ...
                    {heatColumns.map((col) => {
                      ...
                      return (
                        ...
                        >
                          <span
                            className={`inline-block min-w-[40px] text-center px-2 py-1 rounded-lg text-[12px] font-semibold ${heatColor(score)}`}
                            style={GEO}
                          >
                            {score.toFixed(1)}
                          </span>
                    ...
                    <div className="w-[90px] shrink-0 flex justify-center">
                      <span
                        className="px-3 py-1 rounded-full border border-gray-200 dark:border-white/10 text-[11px] text-gray-500 dark:text-gray-400 font-medium"
                        style={GEO}
                      >
                        Adaptive
                      </span>
                      ...
                      <div className="flex flex-col gap-2">
                        {heatColumns.map((col) => {
                          ...
                          return (
                            ...
                            >
                              <span
                                className="text-[11px] text-gray-500 dark:text-gray-400 w-[120px] shrink-0"
                                style={GEO}
                              >
                                {col.label}
                              </span>
                              ...
                              <span
                                className="text-[11px] font-semibold text-gray-700 dark:text-gray-300 w-8 text-right shrink-0"
                                style={GEO}
                              >
                                {score.toFixed(1)}
                              </span>
          ...
          <div className="flex items-center gap-4 mt-4 flex-wrap">
            {[
              ...
              {
                label: "Fair (≥1.5)",
                cls: "bg-yellow-50 dark:bg-yellow-900/20",
              },
              {
                label: "Needs Work (<1.5)",
                cls: "bg-orange-50 dark:bg-orange-900/20",
              },
            ].map((l) => (
          ...
          <div className="relative">
            <div className="space-y-4 max-h-[360px] overflow-y-auto px-4 -mt-2 pt-2 pb-10 no-scrollbar">
              {[
                ...
                <div
                  key={i}
                  className="p-4 rounded-[20px] bg-white dark:bg-gray-800 border border-gray-200/60 dark:border-white/5 shadow-[inset_0_1px_4px_rgba(0,0,0,0.06)] hover:shadow-xl hover:translate-y-[-2px] transition-all duration-300 cursor-pointer flex flex-col gap-3 group"
                >
                  <div className="flex items-center gap-2">
                    <div
                    ...
                    <div className="flex-1 min-w-0">
                      <p
                        className="text-[13px] font-semibold text-gray-800 dark:text-white leading-tight truncate"
                        style={GEO}
                      >
                        {item.title}
                      </p>
                    ...
                    <span
                      className="text-[12px] font-medium text-gray-600 dark:text-gray-300 shrink-0"
                      style={GEO}
                    >
                      {item.progress}%
                    </span>
              ...
              {[
                ...
                >
                  <div className="flex flex-col items-start gap-1.5 text-left pr-8 flex-1">
                    ...
                    <div>
                      <p
                        className="text-[14px] font-semibold text-gray-800 dark:text-gray-200 leading-tight"
                        style={GEO}
                      >
                        {rec.title}
                      </p>
        ...
        <Card className="col-span-12 md:col-span-6 xl:col-span-4 p-4 rounded-lg bg-white dark:bg-gray-800 border-none shadow-none">
          ...
          <div className="flex flex-col gap-2">
            {[
              ...
              <div
                key={member.name}
                className="flex items-center gap-3 p-3 rounded-2xl bg-white dark:bg-gray-800 border border-gray-200/60 dark:border-white/5 shadow-[inset_0_1px_4px_rgba(0,0,0,0.06)] hover:shadow-xl hover:translate-y-[-2px] transition-all duration-300 cursor-pointer"
              >
                <span
                  className="w-5 text-center text-[12px] font-bold text-gray-400 shrink-0"
                  style={GEO}
                >
                  {member.rank}
                </span>
                ...
                <div className="flex-1 min-w-0">
                  <p
                    className="text-[13px] font-semibold text-gray-800 dark:text-white truncate"
                    style={GEO}
                  >
                    {member.name}
                  </p>
...
function ManagerDashboard({ onLogout, username }: ManagerDashboardProps) {
  ...
  const [assessmentSubPage, setAssessmentSubPage] = useState<string | null>(
    null,
  );
  ...
  useEffect(() => {
    ...
    return () =>
      window.removeEventListener("assessment:subpage", handleSubPage);
  }, []);

  useEffect(() => {
    if (location.pathname !== "/assessment") {
      queueMicrotask(() => setAssessmentSubPage(null));
    }
  }, [location.pathname]);
                        ...
                        <BreadcrumbLink
                          onClick={() =>
                            window.dispatchEvent(
                              new CustomEvent("assessment:back"),
                            )
                          }
            ...
            <div className="pt-16">
              <Routes>
                ...
                <Route
                  ...
                  element={<CompetencyProfilePage role="manager" />}
                />
                <Route
                  path="/my-idp-learning/*"
                  element={<MyIDPLearningPage role="manager" />}
                />
