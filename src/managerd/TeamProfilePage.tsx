    ...
    coreDefinitions: [
      {
        title: "Create Impact",
        description:
          "มุ่งผลงานที่มีนัยสำคัญต่อทีม ในสิ่งที่มีคุณค่าต่อองค์กร เข้าใจบทบาทที่โดดเด่น และรับผิดชอบ",
      },
      {
        title: "Take Ownership",
        description:
          "Own ผลงานแบบ end-to-end พร้อม solve ปัญหาเมื่อเจอแบบไม่หนีความรับผิดชอบต้นเรื่อง",
      },
      {
        title: "Adaptive",
        description:
          "สามารถแก้ไขปัญหาได้ดี รักการเรียนรู้ เปิดรับการเปลี่ยนแปลง",
      },
      {
        title: "Collaboration",
        description:
          "การทำงานเป็นทีมและร่วมมือมีวินัยมีความรับผิดชอบให้เกิดประโยชน์ เข้าใจบทบาทของตัวเอง",
      },
    ],
  },
  {
...
function MemberDetail({ m, onBack }: { m: TeamMember; onBack: () => void }) {
  ...
  const activeDefinitions =
    coreType === "Core"
      ...
      : [
          {
            title: "FC01 · Data Analysis",
            description:
              "วิเคราะห์ข้อมูลเพื่อสกัด insight และสนับสนุนการตัดสินใจทางธุรกิจได้อย่างมีประสิทธิภาพ",
          },
          {
            title: "FC02 · Stakeholder Communication",
            description:
              "สื่อสารได้ชัดเจนและมีประสิทธิผลกับทุกระดับของ stakeholder ทั้งภายในและภายนอกองค์กร",
          },
          {
            title: "FC03 · Strategic Thinking",
            description:
              "เชื่อมโยงงานประจำวันเข้ากับเป้าหมายระยะยาวขององค์กร มองภาพรวมและวางแผนเชิงกลยุทธ์",
          },
          {
            title: "FC04 · Project Execution",
            description:
              "ส่งมอบโปรเจกต์ตรงเวลา ตรงขอบเขต และได้มาตรฐานคุณภาพที่กำหนด",
          },
          {
            title: "FC05 · Process Improvement",
            description:
              "ระบุและนำการปรับปรุง workflow ที่มีความหมายมาใช้งาน เพื่อเพิ่มประสิทธิภาพของทีม",
          },
        ];
    ...
    <div className="flex flex-col gap-6 p-6 bg-[#f8fafc] dark:bg-transparent min-h-screen">
        ...
        {[
          ...
          >
            ...
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 relative z-10">
              ...
              <div className="h-10 w-10 rounded-full bg-white/20 flex items-center justify-center backdrop-blur-sm group-hover:scale-110 group-hover:rotate-12 transition-all duration-500">
                {c.icon}
              </div>
            </CardHeader>
            <CardContent className="relative z-10">
              ...
              <p className="text-sm text-white/80 font-medium" style={GEO}>
                {c.sub}
              </p>
            </CardContent>
          </Card>
      ...
      <div className="grid gap-6 lg:grid-cols-7">
        ...
        <div className="lg:col-span-4 space-y-6">
          {/* Profile card */}
          <Card
            className="border-none shadow-lg bg-gradient-to-br from-white to-blue-50/50 dark:from-gray-800 dark:to-gray-900 overflow-hidden relative hover:shadow-2xl transition-all duration-500"
            style={fadeUp(200)}
          >
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-start gap-4 shrink-0">
                  <div className="text-center">
                    ...
                    <div className="text-[10px] text-gray-400" style={GEO}>
                      XP
                    </div>
                  </div>
                  <div className="text-center">
                    <div
                      className="text-[22px] font-bold text-emerald-600 dark:text-emerald-400"
                      style={GEO}
                    >
                      {m.progress}%
                    </div>
          ...
          <div className="grid grid-cols-3 gap-3" style={fadeUp(280)}>
            {[
              ...
              <div
                key={si}
                className="flex items-center gap-3 p-3 rounded-2xl bg-white dark:bg-gray-800 border border-gray-200/60 dark:border-white/5 shadow-[inset_0_1px_4px_rgba(0,0,0,0.06)]"
              >
                <div
                ...
                <div>
                  <p
                    className="text-[18px] font-bold text-gray-800 dark:text-white leading-none"
                    style={GEO}
                  >
                    {s.value}
                  </p>
          ...
          <div className="grid gap-4 md:grid-cols-2" style={fadeUp(320)}>
            <Card className="p-4 rounded-2xl bg-white dark:bg-gray-800 border-none shadow-sm">
              <h3
                className="text-[16px] font-medium text-[#08060d] dark:text-white mb-3 flex items-center gap-2"
                style={GEO}
              >
              ...
              <div className="rounded-2xl bg-white dark:bg-gray-800 border border-gray-200/60 dark:border-white/5 shadow-[inset_0_1px_4px_rgba(0,0,0,0.06)] p-3 space-y-2.5">
                {m.strengths.map((item, i) => (
                  <div key={i} className="flex items-center gap-2.5">
                    ...
                    <span
                      className="text-[11px] text-gray-700 dark:text-gray-200 font-medium leading-tight"
                      style={GEO}
                    >
                      {item}
                    </span>
          ...
          <Card
            className="p-4 rounded-lg bg-white dark:bg-gray-800 border-none shadow-none relative"
            style={fadeUp(400)}
          >
            ...
            <div className="flex items-baseline justify-between mb-2 relative z-20">
              ...
              <div className="relative" ref={categoryRef}>
                ...
                >
                  {selectedCategory}
                  <ChevronDown
                    className={`w-3.5 h-3.5 transition-transform duration-300 ${isCategoryOpen ? "rotate-180 text-[#FC4C02]" : "rotate-0"}`}
                  />
                </button>
                <div
                  className={`absolute top-full right-0 mt-2 w-36 bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-xl border border-gray-200/50 dark:border-transparent p-1 z-50 transition-all duration-300 origin-top-right shadow-xl ${isCategoryOpen ? "opacity-100 scale-100 translate-y-0" : "opacity-0 scale-95 -translate-y-2 pointer-events-none"}`}
                >
                ...
                <div className="w-fit ml-auto space-y-2.5">
                  <div className="py-3.5 px-3.5 rounded-2xl bg-white dark:bg-gray-800 border border-gray-200/60 dark:border-white/5 shadow-[inset_0_1px_4px_rgba(0,0,0,0.06)]">
                    ...
                    <div className="flex items-end gap-1.5">
                      ...
                      >
                        <AnimatedNumber
                          value={isMounted ? m.competencyScore : 0}
                          decimals={1}
                        />
                      </span>
        ...
        <div className="lg:col-span-3 space-y-6">
          {/* Core Definition */}
          <Card
            className="border-none shadow-lg hover:shadow-xl transition-all duration-500 bg-white dark:bg-gray-800"
            style={fadeUp(300)}
          >
            ...
            <CardContent className="space-y-3 pt-0">
              {activeDefinitions.map((def, i) => (
                ...
                >
                  <h3
                    className="font-semibold text-left text-[12px] mb-1 text-gray-900 dark:text-gray-100 group-hover:text-purple-700 dark:group-hover:text-purple-300 transition-colors"
                    style={GEO}
                  >
                    {def.title}
                  </h3>
                  <p
                    className="text-[11px] text-left text-gray-500 dark:text-gray-400 leading-relaxed"
                    style={GEO}
                  >
                    {def.description}
                  </p>
          ...
          {/* Growth Timeline */}
          <Card
            className="border-none shadow-lg hover:shadow-xl transition-all duration-500 bg-white dark:bg-gray-800 relative overflow-hidden"
            style={fadeUp(400)}
          >
...
export default function TeamProfilePage() {
  ...
  if (selectedMember) {
    return (
      <MemberDetail m={selectedMember} onBack={() => setSelectedMember(null)} />
    );
  }
  ...
  return (
    ...
    >
      ...
      <div className="mb-6">
        <h1
          className="text-[22px] font-semibold text-[#08060d] text-left dark:text-white mb-1"
          style={GEO}
        >
          Team Profile
        </h1>
        <p
          className="text-[13px] text-left text-gray-500 dark:text-gray-400"
          style={GEO}
        >
          {TEAM.length} members · Click any member to view their full competency
          profile
        </p>
      </div>
      ...
      <div className="grid grid-cols-12 gap-6 items-start">
        ...
        <div className="col-span-12 xl:col-span-5 flex flex-col gap-4">
          ...
          <div className="rounded-2xl bg-white dark:bg-gray-800 border border-gray-200/60 dark:border-white/5 shadow-[inset_0_1px_4px_rgba(0,0,0,0.06)] p-4">
            <h2
              className="text-[16px] font-semibold text-[#08060d] dark:text-white mb-3"
              style={GEO}
            >
              Top Performer
            </h2>
              ...
              {topPerformers.map((m) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[11px] text-gray-400 mb-1" style={GEO}>
                      {m.position}
                    </p>
                    <div className="flex items-center gap-1.5">
                      <span
                  ...
                  <div className="flex flex-col items-center gap-1 shrink-0">
                    <span
                      className="text-[11px] font-semibold text-gray-600 dark:text-gray-300 whitespace-nowrap"
                      style={GEO}
                    >
                      Level {m.level}
                    </span>
              ...
              {[
                {
                  ...
                  value: (
                    TEAM.reduce((s, m) => s + m.competencyScore, 0) /
                    TEAM.length
                  ).toFixed(1),
                  sub: "/ 5.0",
                ...
                {
                  label: "Active IDPs",
                  value: TEAM.reduce((s, m) => s + m.activeIDPs, 0).toString(),
                  sub: "plans",
                ...
                <div
                  key={s.label}
                  className="flex items-center justify-between py-2 border-b border-gray-100 dark:border-white/5 last:border-b-0"
                >
                  <span
                    className="text-[12px] text-gray-500 dark:text-gray-400"
                    style={GEO}
                  ...
                  <div className="flex items-baseline gap-1">
                    ...
                    <span className="text-[11px] text-gray-400" style={GEO}>
                      {s.sub}
                    </span>
                  </div>
                </div>
                ...
                return (
                  <div key={pos}>
                    ...
                    <div className="h-1.5 w-full bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden">
                      <div
                        className="h-full bg-[#006bff] rounded-full transition-all duration-700"
                        style={{ width: `${pct}%` }}
                      />
                    </div>
                  </div>
